...
\begin{itemize}
	...
	\item \textbf{Solicitante de serviços}: Entidade que requer um determinado serviço e solicita a sua execução. O solicitante de serviço pode ser uma pessoa acessando pelo navegador ou uma outra aplicação realizando solicitações por meio de APIs.
\end{itemize}
