...
O objetivo do trabalho é a proposta de um arquitetura orientada a serviços baseada no RAMI4.0 para o compartilhamento da memória digital do produto ao longo da cadeia suprimentos (\autoref{cha:arquitetura}) e a proposta de tipos de dados do produto em forma de submodelos a serem compartilhados pela cadeia de suprimentos (\autoref{cha:ciclo-de-vida}).
...
Portanto, os eixos ``Camadas'' e ``Ciclo de Vida e Cadeia de Valor'' do RAMI4.0 são detalhados de forma a se aperfeiçoar a elaboração dessa arquitetura e proporcionar mais robustez ao modelo para uma futura adoção generalizada por parte de empresas por todo o mundo.
