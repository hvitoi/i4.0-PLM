...
A lógica de fornecimento e consumo de serviços proposta para a I4.0 segue os moldes de um \textit{Web Service} detalhado na \autoref{sec:soa}, onde foram apresentados os componentes e operações (vide \autoref{fig:webservice-componentes}) adaptados ao AAS.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{webservice-rami}
