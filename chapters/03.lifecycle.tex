...
Além disso, \citeonline{bader2020submodel} definem alguns submodelos padrões para a I4.0 e detalha suas respectivas propriedades.
...
Este submodelo do C4.0-Produto é baseada em \citeonline{bedenbender2017aasexamples}, que menciona a necessidade da existência de um submodelo destinado ao armazenado de arquivos binários que não possuem um formato específico.
