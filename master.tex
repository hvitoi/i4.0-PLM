...
% ----------------------------------------------------------
\frenchspacing
\include{conteudo/0-pre-textual}
...
\include{conteudo/2-metodologia}
\include{conteudo/3-fundamentos}
\include{conteudo/4-arquitetura}
\include{conteudo/5-ciclo-de-vida}
\include{conteudo/6-prova-de-conceito}
\include{conteudo/7-conclusao}

% ----------------------------------------------------------
% ELEMENTOS PÓS-TEXTUAIS
% ----------------------------------------------------------
\postextual
\include{conteudo/8-bibliografia}
