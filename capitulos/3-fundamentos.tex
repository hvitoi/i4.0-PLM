...
\section{Arquitetura orientada a serviços (SOA)}
	...
	\begin{figure}[hbt!]
		...
		\source{\citeonline{gosewehr2017middleware} (adaptado).}
	\end{figure}
	...
	\begin{figure}[hbt!]
		...
		\source{\citeonline{kreger2001webservices} (adaptado).}
	\end{figure}
	...
	\begin{figure}[hbt!]
		...
		\source{\citeonline{booth2004webservice} (adaptado).}
	\end{figure}
	...
	\begin{table}[hbt!]
		...
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{p{3cm}p{3cm}p{5cm}p{5cm}}
				...
				{\color[HTML]{333333} \textbf{Operação}} &
				{\color[HTML]{333333} \textbf{Método HTTP}} &
				{\color[HTML]{333333} \textbf{Resposta (vários itens)}} &
				{\color[HTML]{333333} \textbf{Resposta (item específico)}} \\ 
					
				\hline
				\rowcolor[HTML]{FFFFFF}
				{\color[HTML]{000000} Criação} & 
				{\color[HTML]{000000} POST} &
				{\color[HTML]{000000} 201 (Criado)} &
				{\color[HTML]{000000} Não aplicável.} \\
				
				\rowcolor[HTML]{F7F7F7} 
				{\color[HTML]{000000} Leitura} &
				{\color[HTML]{000000} GET} &
				{\color[HTML]{000000} 200 (OK)} &
				{\color[HTML]{000000} 200 (OK) ou 404 (Não encontrado)} \\
				
				\rowcolor[HTML]{FFFFFF} 
				{\color[HTML]{000000} Atualização} &
				{\color[HTML]{000000} PATCH} &
				{\color[HTML]{000000} 405 (Não permitido)} &
				{\color[HTML]{000000} 200 (OK), 204 (Sem conteúdo) ou 404 (Não encontrado)} \\
				
				\rowcolor[HTML]{F7F7F7} 
				{\color[HTML]{000000} Exclusão} &
